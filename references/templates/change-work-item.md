...
> **State**: Proposed / Ready / In progress / Merge ready / Releasable / Observing / Closed / Blocked / Cancelled
> **Owner**: [Name or role]
...
- Origin IDs (`REQ/AC/BUG/TECH/SEC/OPS`):
- In scope:
- Non-goals:
...
- Merge/PR/build/release evidence:
- Observation window and result:
- Baseline/ledger updates:
- Follow-up `BUG/TECH/SEC/OPS/REQ` items:
