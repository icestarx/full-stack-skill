...
assumptions. Run cases multiple times per model/Skill version and retain pass rate,
time, tool calls, manual corrections, and escaped defects outside this repository.
